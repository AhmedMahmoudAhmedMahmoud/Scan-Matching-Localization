	...
	while (!viewer->wasStopped())
  	{
		...
		if(!new_scan){
          ...
          vg.filter(*cloudFiltered);
			...
			// TODO: Find pose transform by using ICP or NDT matching and get the pose
			...
			pcl::transformPointCloud(*cloudFiltered, *transformed, transform);
			viewer->removePointCloud("scan");

			// TODO: Change `scanCloud` below to your transformed scan
			renderPointCloud(viewer, transformed, "scan", Color(1, 0, 0));
